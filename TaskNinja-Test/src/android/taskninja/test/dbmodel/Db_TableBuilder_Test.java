...
import android.taskninja.dbmodel.Db_TableBuilder;
import android.test.AndroidTestCase;
import android.util.Log;


public class Db_TableBuilder_Test extends AndroidTestCase {
	...
	public void testBuild(){
		Db_TableBuilder builder = new Db_TableBuilder("TEST");
