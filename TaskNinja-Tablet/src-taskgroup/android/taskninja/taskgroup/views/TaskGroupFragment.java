...
public class TaskGroupFragment extends Fragment implements OnActionListener<Task> {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		...
		inflater.inflate(com.rocksolidmobility.taskninja.android.R.layout.taskgroup, container);
		LinearLayout root = (LinearLayout) container.findViewById(com.rocksolidmobility.taskninja.android.R.id.root);
